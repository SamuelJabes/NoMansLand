...
public class BossHealth : MonoBehaviour
{
    ...
    [Header("�udio de Morte")]
    [Tooltip("Som do grito/morte do boss.")]
    public AudioClip deathSFX;

    // Pode ir at� 2 aqui, mas lembre que o AudioClip em si tamb�m tem volume.
    [Range(0f, 2f)]
    public float deathSFXVolume = 1.0f;

    [Tooltip("Se marcado, toca o som em 2D na c�mera (sem perder volume por dist�ncia).")]
    public bool deathSFXAs2D = true;

    [Header("Camera Shake na Morte")]
    [Tooltip("C�mera que vai tremer. Se vazio, usa Camera.main.")]
    ...
    void Awake()
    {
        ...
        // tenta pegar camera principal se n�o tiver setado
    ...
    /// <summary>
    /// Retorna se o boss está morto (para auto-aim system)
    /// </summary>
    public bool IsDead()
    {
        return dead;
    ...
    void Die()
    {
        // desliga l�gica de movimento/ataque
        var bossController = GetComponent<BossController>();
        if (bossController != null)
            bossController.enabled = false;

        // desativa colisores pra n�o bater mais em nada
    ...
    void PlayDeathSFX()
    {
        ...
        // 2D na c�mera (sem atenua��o por dist�ncia)
        ...
        {
            // fallback 3D no mundo (perde volume com dist�ncia)
    ...
    {
        // come�a o shake da c�mera em paralelo
        ...
        {
            Debug.LogError("[BossHealth] endSceneName n�o configurado!");
        }
    }
